...
class ErrorMessages private constructor() {
    companion object{
        ...
        const val connectionErrorMessage = "A connection error has occurred. Please check your internet."
        ...
        const val invalidTokenMassage="Sorry, you do not have the necessary permissions. Please log in again to continue"
